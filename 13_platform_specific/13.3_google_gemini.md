...
> **说明：** Google 模型页当前将 Gemini 3.6 Flash（最新）与 Gemini 3.5 Flash 同标为 Stable，将 Gemini 3.1 Pro 标为 Preview。生产系统不要把 Preview、`latest` 别名、上下文窗口或价格写死在业务逻辑中。
...
| 模型 | 上下文窗口 | 核心特点 | 适用场景 |
|------|-----------|---------|----------|
| Gemini 3.6 Flash | 1,048,576 输入 / 65,536 输出 token | Stable、Gemini 3 系列最新型号，面向代码生成、agent 执行与空间推理 | 生产首选、快速 agent 循环与多模态工作流 |
