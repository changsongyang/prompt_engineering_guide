...
| Gemini 2.5 Pro | 2M tokens | 最强能力、多模态 | 复杂分析、长文档 |
| Gemini 2.0 Pro | 2M tokens | 前代旗舰、多模态 | 复杂分析、长文档 |
...
> **上下文窗口详解**：Gemini 1.5 Pro 首次引入百万级上下文（1M tokens），后续 Gemini 2.0/2.5 Pro 系列升级至 2M tokens。超长上下文可处理约 150 万字的中文文本、整本书籍或约 1 小时的视频内容。
...
Gemini Pro 系列的百万级到 2M 上下文能力可以处理：
- Gemini 1.5/3 Pro（1M tokens）：约 75 万字的中文文本、整部小说
- Gemini 2.0/2.5 Pro（2M tokens）：约 150 万字的中文文本、长篇技术书籍、约 1 小时的视频、约 10 小时的纯音频
